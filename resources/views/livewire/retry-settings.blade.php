    ...
    <section class="card card-pad">
        <div class="grid gap-3" style="grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));">
            <div>
                ...
                <input id="retry-max" class="input" type="number" min="1" max="10" wire:model.live="retryMaxAttempts">
                <p class="muted field-hint">Veces que un job puede reintentarse antes de marcar error definitivo.</p>
            ...
            <div>
                ...
                <p class="muted field-hint">Espera entre intentos sucesivos.</p>
            ...
            <div>
                ...
                <input id="retry-timeout" class="input" type="number" min="5" max="120" wire:model.live="retryHttpTimeout">
                <p class="muted field-hint">Tiempo máximo esperando respuesta de Botmaker o Bitrix24.</p>
