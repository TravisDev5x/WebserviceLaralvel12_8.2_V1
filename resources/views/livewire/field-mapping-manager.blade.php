<div>
    ...
    <section class="card card-pad" style="margin-bottom: 1rem;">
        <div class="grid gap-3" style="grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));">
            <div><label>Plataforma origen</label><input class="input" wire:model.live="source_platform" type="text"></div>
            <div><label>Campo origen</label><input class="input" wire:model.live="source_field" type="text"></div>
            <div><label>Path origen</label><input class="input" wire:model.live="source_path" type="text"></div>
            <div><label>Plataforma destino</label><input class="input" wire:model.live="target_platform" type="text"></div>
            <div><label>Campo destino</label><input class="input" wire:model.live="target_field" type="text"></div>
            <div><label>Path destino</label><input class="input" wire:model.live="target_path" type="text"></div>
            <div>
            ...
            <div style="grid-column: 1 / -1;"><label>Config transformación (JSON)</label><textarea class="textarea" rows="4" wire:model.live="transform_config"></textarea></div>
        </div>
