...
Route::middleware(['auth'])->group(function (): void {
    ...
    Route::get('/monitor/manual', IntegrationManual::class)->name('manual.app');
    ...
    Route::redirect('/monitor/mappings', '/monitor/field-mappings');
    ...
    Route::get('/monitor/field-mappings', FieldMappingManager::class)->middleware(['role.ops', 'permission:mappings.manage']);
